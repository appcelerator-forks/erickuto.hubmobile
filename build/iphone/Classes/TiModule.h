...
/**
 The base class for all hubmobile modules
 */
...
/**
 hubmobile Platform calls this method on startup.
 */
-(void)startup;

/**
 hubmobile Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 hubmobile Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 hubmobile Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 hubmobile Platform calls this method on resume.
 @param sender The sender of the event.
 */
