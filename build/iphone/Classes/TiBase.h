...
// in simulator we redefine to format for hubmobile Developer console
...
{\
	NSString * exceptionName = [@"org.hubmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hubmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIhubmobileNativeItemNone = -1, 
	UIhubmobileNativeItemSpinner = -2,
	UIhubmobileNativeItemProgressBar = -3,
	
	UIhubmobileNativeItemSlider = -4,
	UIhubmobileNativeItemSwitch = -5,
	UIhubmobileNativeItemMultiButton = -6,
	UIhubmobileNativeItemSegmented = -7,
	
	UIhubmobileNativeItemTextView = -8,
	UIhubmobileNativeItemTextField = -9,
	UIhubmobileNativeItemSearchBar = -10,
	
	UIhubmobileNativeItemPicker = -11,
	UIhubmobileNativeItemDatePicker = -12,
	
	UIhubmobileNativeItemInfoLight = -13,
	UIhubmobileNativeItemInfoDark = -14,
	
	UIhubmobileNativeItemDisclosure = -15,
	
	UIhubmobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all hubmobile instances of
