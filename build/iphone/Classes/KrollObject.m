 ...
 * Copyright (c) 2009-2011 by hubmobile, Inc. All Rights Reserved.
...
//@interface hubmobileObject : NSObject
//@end

@interface hubmobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[hubmobileObject class]])
		{
			for (NSString *key in [[(hubmobileObject*)o modules] allKeys])
			{
