...
@interface hubmobileObject : KrollCoverageObject {
#else
@interface hubmobileObject : KrollObject {
#endif
@private
...
extern NSString * hubmobile$ModuleRequireFormat;
