...
/**
 Base class for all hubmobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the hubmobile view hierarchy (such as wrapped iOS UIViews) was touched.
